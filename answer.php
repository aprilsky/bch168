 ...
 * 如果您的模板要进行修改，请修改 templates/default/answer.html
 * 如果您的模型要进行修改，请修改 models/answer.php
 *
...
if(filemtime("templates/default/answer.html") > filemtime(__file__) || (file_exists("models/answer.php") && filemtime("models/answer.php") > filemtime(__file__)) ) {
	tpl_engine("default","answer.html",1);
	include(__file__);
} else {
/* debug模式运行生成代码 结束 */
?><?php
