        ...
        <div class="iml">
            ...
            <ul>
                ...
                while ($row = mysql_fetch_array($result)) {
                    ?>
                    <li>
                        <a href="/goods.php?id=<?php echo $row['goods_id']; ?>"
                           target="_blank"><?php echo $row['goods_name']; ?></a><br>
                    </li>
                <?
                }
                ?>
        ...
        <div class="imr">
            ...
            <ul>
                <marquee scrollamount="1" direction="up"
                         style="margin: 0 auto;padding: 0; width: 240px; height: 280px;">
                    <?php
                ...
                <?php foreach ($goods_promote as $value) { ?>
                    ...
                    <li>
                        <table>
                            <tr>
                                <td valign="top">
                                    <a href="<?php echo goods_url($value['goods_id']); ?>"><img
                                            src="<?php echo $value['is_set_image'] ? str_replace('thumb_', '', $value['goods_thumb']) : 'skin/default/images/nopic.gif'; ?>"
                                            alt="<?php echo $value['goods_name']; ?>" width="112" height="112"
                                            onerror="this.src='skin/default/images/nopic.gif'" border="0"/></a></td>
                                <td valign="top" style="padding-left:10px;line-height:22px;">
                                    <a href="<?php echo goods_url($value['goods_id']); ?>"
                                       target="_blank"><?php echo $value['goods_name']; ?></a><br>
                                    品种：
                                    <?php
                                    $catids = $value['cat_id'];
            ...
            <?php if (isset($CATEGORY[$cat['cat_id']]) && $CATEGORY[$cat['cat_id']]) { ?>
                <ul>
                    <?php foreach (array_slice($CATEGORY[$cat['cat_id']], 0, 8) as $subcat) { ?>
                        <li><a href="<?php echo category_url($subcat['cat_id']); ?>"
                               title="<?php echo $cat['cat_name']; ?>"><?php echo $subcat['cat_name']; ?></a></li>
                    <?php } ?>
                </ul>
            <?php } ?>
            <div class="iflm">
        ...
        <div class="imcc">
            <ul>
                ...
                while ($row = mysql_fetch_array($result)) {
                    ?>
                    <li>
                        <a href="/goods.php?id=<?php echo $row['goods_id']; ?>"><img
                                src="<?php echo $row['goods_thumb']; ?>" alt="" border="0" class="itt"></a><br>
                        <a href="/goods.php?id=<?php echo $row['goods_id']; ?>"
                           target="_blank"><?php echo $row['goods_name']; ?></a><br>
                        ...
                        <a href="/goods.php?id=<?php echo $row['goods_id']; ?>" target="_blank"><img src="/css/gm.jpg"
                                                                                                     border="0"></a>&nbsp;&nbsp;
                        <a href="/goods.php?id=<?php echo $row['goods_id']; ?>" target="_blank"><img src="/css/sc.jpg"
                                                                                                     border="0"></a><br>
        ...
        <div class="ilk">
            <ul>
                ...
                while ($row = mysql_fetch_array($result)) {
                    ?>
                    <li>
                        <a href="/goods.php?id=<?php echo $row['site_url']; ?>"
                           target="_blank"><?php echo $row['brand_name']; ?></a><br>
                    </li>
