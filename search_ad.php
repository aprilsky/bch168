...
$i_langpackage = new indexlp;
	...
	$header['title'] = $i_langpackage->i_serach_ad;
	$header['keywords'] = $i_langpackage->i_serach_ad;
...
<TABLE cellSpacing=8 cellPadding=0 width="100%" align=center border=0>
  ...
  <TR>
    ...
    <TD><SELECT name="cat_id">
     <OPTION value="0" ><?php echo $i_langpackage->i_search_category;?></OPTION>
  ...
  <TR>
    ...
    <TD><SELECT name="brand_id" >
     <OPTION value="0" ><?php echo $i_langpackage->i_search_brand;?></OPTION>
