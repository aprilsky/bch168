...
<div class="header">
    ...
    <?php  if($SYSINFO['sys_logo']){?>
		<div class="logo left">
	    	<a href="index.php"><img style="-moz-background-clip:border;-moz-background-inline-policy:continuous;-moz-background-origin:padding;display:block;height:43px;margin:8px 0 0 8px;overflow:hidden;text-indent:9999px;width:177px;" src="<?php echo  $SYSINFO['sys_logo'];?>" onerror="this.src='skin/default/images/nopic.gif'"/>
</a>
	    </div>
	<?php } else {?>
		<div class="logo left">
