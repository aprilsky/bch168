...
<?php  include("messagebox.php");?>
	<div class="warp">
    	<div class="content">
            ...
            <div class="item"><div class="input"><div class="icon2" title="<?php echo $a_langpackage->a_password; ?>"></div><input tabindex="2" type="password" name="admin_password" value="" id="admin_password"/></div>
            
            <label><?php echo $a_langpackage->a_password; ?>：</label></div><input type="submit" tabindex="3" value="" class="submit" />
            </form>
...
function checkform() {
	...
	if(admin_password) {
		...
		ShowMessageBox('<?php echo $a_langpackage->a_admin_password;?>','0');
		return false;
	}
}
//-->
